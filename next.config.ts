    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Cross-Origin-Opener-Policy', value: 'unsafe-none' },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jotfor.ms https://form.jotform.com https://www.googletagmanager.com https://www.google-analytics.com https://googleads.g.doubleclick.net https://www.googleadservices.com",
              ...
              "media-src 'self'",
              "frame-src https://form.jotform.com https://submit.jotform.com https://www.googletagmanager.com https://googleads.g.doubleclick.net https://td.doubleclick.net",
              "frame-ancestors 'self'",
              "connect-src 'self' https://form.jotform.com https://api.jotform.com https://cdn.jotfor.ms https://submit.jotform.com https://www.googletagmanager.com https://www.google-analytics.com https://analytics.google.com https://tagassistant.google.com https://www.google.com https://googleads.g.doubleclick.net https://www.googleadservices.com https://stats.g.doubleclick.net https://td.doubleclick.net",
      ...
      {
        // Sanity Studio — must come after /:path* so this CSP wins
        source: '/studio/:path*',
        headers: [
